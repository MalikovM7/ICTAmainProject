            ...
            @foreach($cars as $car )
                <tr>
                    ...
                    <td>{{$car->price}}</td>
                     ...
                     <a class="btn btn-info" href="{{route('product.edit.admin',['car' => $car])}}" role="button"><i class="fa-solid fa-pen-to-square"></i></a>
                     ...
                     <td>
                        <form method="post" action="{{route('product.delete.admin', ['car' => $car])}}">
                            @csrf 
                            @method('delete')
